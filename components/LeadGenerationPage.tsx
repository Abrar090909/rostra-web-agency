        ...
        <InternalPageLayout>
            <div className="max-w-[1200px] mx-auto">
                <motion.div
                    ...
                    className="mb-20"
                >
                    <span className="text-[#E02424] text-[12px] uppercase tracking-[0.3em] font-bold block mb-4">Service — 03</span>
                    <h1 className="text-[clamp(40px,7vw,100px)] font-bold tracking-tightest leading-none text-white mb-8">
                        Lead <span className="text-white/20">Generation</span>
                    </h1>
                    <p className="text-xl md:text-2xl text-white/40 max-w-[700px] leading-relaxed">
                        Targeted campaigns and optimized funnels designed to attract, capture, and convert high-quality prospects into B2B clients.
                    </p>
                </motion.div>
                ...
                >
                    <img
                        src="/images/services/lead-gen.png"
                        alt="Lead Generation"
                ...
                <div className="grid lg:grid-cols-[1fr_400px] gap-20">
                    ...
                    <div className="bg-[rgb(17,17,17)] rounded-[32px] p-10 border border-white/5 h-fit sticky top-32">
                        <h3 className="text-2xl font-bold text-white mb-4">Attract B2B clients</h3>
                        <p className="text-white/40 mb-8 leading-relaxed">
                            Turn your website into a 24/7 sales representative that never sleeps.
                        </p>
